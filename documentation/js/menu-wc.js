...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">trackaday documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/AppData.html" data-type="entity-link" >AppData</a>
                            </li>
                            <li class="link">
                                <a href="classes/DataKey.html" data-type="entity-link" >DataKey</a>
                            </li>
                            <li class="link">
                                <a href="classes/IpcService.html" data-type="entity-link" >IpcService</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/Break.html" data-type="entity-link" >Break</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Session.html" data-type="entity-link" >Session</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/TaskTimestamp.html" data-type="entity-link" >TaskTimestamp</a>
                            </li>
                            <li class="link">
